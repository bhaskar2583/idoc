    ...
    public class ClientService : IClientService
    {
        ...
        public IList<ClientModel> GetAllClients()
        {
            ...
            clientsData.ForEach(c =>
            {
                ...
                //client.SelectedDivision = client.Divisions.FirstOrDefault(d => d.Id == Convert.ToInt32(c.Division));
        ...
        public ClientModel GetAllClientPolocies(int clientId)
        {
            ...
            clietPolocies.ToList().ForEach(cli =>
            {
                ...
                clientResult.Policies.Add(policie);
            });
            return clientResult;
        }
        ...
        public IList<ClientModel> ApplyFilterForIndex(string searchClientName, CarrierStatusEnum searchStatus, IList<ClientModel> source)
        {
            if (source == null)
                return null;
